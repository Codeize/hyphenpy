...
class Giveaway(commands.Cog):
    ...
    async def giveaway(self, ctx):
        ...
        questionList = [
            ...
            ["What are you giving away?", "I.E. Discord Nitro, your soul, A Steam Key."]
        ]
        answers = {}
        ...
        embed = discord.Embed(name="Giveaway content", color=ctx.message.author.color)
        ...
        giveawayEmbed = discord.Embed(title="🎉 __**Giveaway**__ 🎉", description=answers[2], color=ctx.message.author.color)
